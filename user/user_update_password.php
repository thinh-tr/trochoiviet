...
<body>
    <div id="header">
        ...
        <nav id="navbar-example2" class="navbar bg-body-tertiary px-3 mb-3">
            <a class="btn btn-primary" href="/user/user_info.php"><i class="bi bi-arrow-left"></i> Thông tin người dùng</a>
        </nav>
    </div>
    ...
    <div id="change-pass-body" class="container">
        <h3 style="text-align: center;"><b>Cập nhật mật khẩu người dùng</b></h3><br>
        <form method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <a class="btn btn-danger" href="/user/user_info.php"><i class="bi bi-x-circle"></i> Hủy</a>
            </div>
        </form>
    </div>
