...
<body>
            ...
            if ($is_valid_array) {
                ...
                if (AdminServices\update_password($_SESSION["admin_email"], $update_password_array["current_password"], $update_password_array["new_password"])) {
                    echo(<<<END
                        ...
                        <h5>Đã cập nhật mật khẩu</h5><br>
                        <p>Hãy đăng nhập lại bằng mật khẩu mới.</p>
                        </div>
                    END);
                } else {
                    echo(<<<END
    ...
    <div id="change-pass-body" class="container">
        <h3 style="text-align: center;"><b>Cập nhật mật khẩu</b></h3>
        <form method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="admin-password" class="form-label">Mật khẩu mới *</label>
                <input type="password" class="form-control" id="new-password" name="new-password">
            </div>
            <div class="mb-3">
                <label for="admin-password" class="form-label">Xác nhận lại mật khẩu mới *</label>
